...
@section('body')
    <div class="wrapper">
        ...
        <tbody>
            @foreach ($onewaydomestic as $oneway)
                <tr>
                    <th scope="row">{{ $oneway->id }}</th>
                    <td>{{ $oneway->lastname }}</td>
                    <td>{{ $oneway->firstname }}</td>
                    <td>{{ $oneway->phone }}</td>
                    <td>{{ $oneway->going_from }}</td>
                    <td>{{ $oneway->going_to }}</td>
                    <td>{{ $oneway->departure_day }}</td>
                    <td>{{ $oneway->status }}</td>
                    <td>{{ $oneway->passport_number }}</td>
